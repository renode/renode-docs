...
extensions = ['sphinx.ext.todo', 'sphinx.ext.ifconfig', 'sphinx_tabs.tabs', 'sphinx.ext.extlinks', 'sphinxcontrib.rsvgconverter', 'myst_parser']
numfig = True
...
# of the sidebar.
html_logo = theme_dir+'/logo-400-html.png'
...
# the title page.
latex_logo = theme_dir+'/logo-latex.pdf'
...
latex_additional_files = ['%s/%s.sty' % (theme_dir,theme),latex_logo]
...
latex_elements = {
    ...
    'maketitle': r'''
        ...
        \renewcommand{\sphinxlogo}{\vspace{2em}\sphinxincludegraphics[width=300pt]{logo-latex.pdf}\vspace{2em}\par}
        \maketitle
    ''',
