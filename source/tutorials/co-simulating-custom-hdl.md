...
Creating HDL models and co-simulating them in Renode is an advanced topic, so be sure to visit the {doc}`../advanced/co-simulating-with-verilator` chapter beforehand.
